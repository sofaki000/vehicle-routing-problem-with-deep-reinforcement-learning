...
class PointerTSP(nn.Module):
    """Calculates the next state given the previous state and input embeddings."""

    def __init__(self, hidden_size, num_layers=1, dropout=0.2):
        super(PointerTSP, self).__init__()
        ...
        self.encoder_attn = AttentionTSP(hidden_size)
...
class NetworkTSP(nn.Module):
    ...
    def __init__(self, static_size, hidden_size,
        ...
        super(NetworkTSP, self).__init__()
        ...
        self.dynamic_encoder = Encoder(static_size, hidden_size, embedding)
        self.static_encoder = Encoder(static_size, hidden_size, embedding)
        self.decoder = Encoder(static_size, hidden_size, embedding)
        self.pointer = PointerTSP(hidden_size, num_layers, dropout)
    ...
    def forward(self, static, decoder_input=None, last_hh=None):
        ...
        for step in range(max_steps):
            ...
            if self.mask_fn is not None:
                mask = self.mask_fn(probs, mask, ptr.data).detach()
        ...
        #print(f'tour idxs returned: {tour_idx}')
